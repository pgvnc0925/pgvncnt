...
export const books: Book[] = [
    ...
    },
    {
        ...
        rating: 4.9,
        reviewCount: 1240,
        coverImage: '/covers/cialdini-le-armi-della-persuasione-sintesi.jpg',
        description: "Molte decisioni umane non nascono da un'analisi razionale, ma da automatismi che si attivano quando l'ambiente presenta certi segnali.",
        readingTimeFull: '8 ore',
        readingTimeSystem: '45 minuti',
